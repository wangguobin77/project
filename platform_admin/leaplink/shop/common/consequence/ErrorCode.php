...
class ErrorCode
{
    ...
    /** 异常 */
    const ERROR = -1;  //所需完成目的失败统一使用(e.g. 注册:注册失败 发送验证码:发送失败 ...)
    ...
    //接口错误定义(go的暂时先放着这里)
    /** 错误的状态 */
    const NOT_EXISTS_a = 200000;
    /** 错误的状态 */
    const CORRECT_STATUS = 200001;
    /** 价格错误 */
    const CORRECT_PRICE = 200002;
    /** 总价格错误 */
    const CORRECT_WORTH = 200003;
