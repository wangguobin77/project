...
class UtilsHelper
{
    private static $postAuthCodeQueueUrl = 'http://b2.service_queue.cn/iis/mobile/get_mobile_authcode';//获取手机验证码
    ...
    public static function sendPhoneCode($phone, $code, $templateIdx = '1'){
        $msg = Yii::$app->params['mobile_template'][$templateIdx];

        //发送手机验证码
        $info = self::postCurl_1(self::$postAuthCodeQueueUrl,['usermobile'=>$phone,'authcode'=>$code,'msg'=>$msg,'authtype'=>1]);//curl请求
