...
//            'index/main'
    ...
    //优惠券相关缓存 key 前缀
    'coupon_cache_key_pre' => [
        'idx_coupon_order_status' => 'leap:coupon:orders:status',
        'idx_coupon_order_code' => 'leap:coupon:orders:code',
    ],
    ...
    'queue_ttr'  => 86400,  //任务队列超时时间
    'queue_cache_redis' => 'queue:cache:redis:',   //记录
    'queue_cache_bin' => 'queue:cache:bin:',   //记录
    'bin_root'  => '/data',   //bin 文件路径 root
