            ...
            <form id="lang_app_form">
                <div class="col-md-12">
                    <div class="form-group col-md-6 input-xx">
                        ...
                        <input name='app_name' type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off"  placeholder="请输入域名名称" >
                    </div>
                </div>
                    ...
                    <div class="form-group col-md-12 input-xx">
                        <div class='radio-inline' style='flex-wrap:wrap'>
                            <?php foreach ($language as $item):?>
                                <div class="col-md-3">
                                    <input type="checkbox" name="language[]" class="minimal" value="<?=$item['id']?>"/>
