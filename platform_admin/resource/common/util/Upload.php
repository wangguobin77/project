...
class Upload {
    ...
    public static $video_directory = 'video_upload';
    ...
    public static function getDirectory($hash_id){
        $directory = DOCROOT . DIRECTORY_SEPARATOR . Upload::$video_directory;
//        $directory = ROOT_PATH.Yii::$app->params['upload_path'];
