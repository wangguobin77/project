...
<!--tishi-->
<!-- 成功提示 -->
<div class="succ" style="position:fixed;top:0;bottom:0;left:0;right:0;display: none;">
...
<!--tishi-->
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display:none;">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li class="active"><a href="../../club/web/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
            <li><a href="../../club/web/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
        </ul>
        <!-- Tab panes -->
...
<!-- jQuery 3 -->
<script src="../../club/web/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="../../club/web/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="../../club/web/js/adminlte.min.js"></script>
<!-- 信息提示  -->
<script src='../../club/web/js/public/ts.js'></script>
<script src='../../club/web/js/public/common.js'></script>
