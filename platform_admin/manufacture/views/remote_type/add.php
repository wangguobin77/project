            ...
            <form id="mymessage-form">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input  type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off"  placeholder="4位数字字母组成"  name="key"  >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input  type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off"  placeholder="4位以0x开头的数字字母组成，不区分大小写" name="code"  >
                    </div>
                </div>
                    ...
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <select name="screen"   class="form-control select2 select2-hidden-accessible col-md-9" style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <?php foreach(Yii::$app->params['screen'] as $key=>$val):?>
                                <option value="<?=$key?>" data-code="<?=$val?>"><?=$key?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
