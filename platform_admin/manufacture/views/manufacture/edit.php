            ...
            <form id="manufacture_form">
                                ...
                                <div class='tpimg-box'>
                                    <div class="bg-icon">
                                            <i>
                                                ...
                                                <img style='width:100px;height:100px' src="<?=$info['logo']?>" align="top" height="80" width="80">
                                            </i>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input name='name' type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" value="<?=$info['name']?>" autocomplete="off"  placeholder="请输入中文名称" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>英文名称:</label>
                        <input name='name_en' type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" value="<?=$info['name_en']?>" autocomplete="off"  placeholder="请输入英文名称" >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input name="login_name" type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" value="<?=$info['login_name']?>" autocomplete="off"  placeholder="请输入登录账号" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>联系人:</label>
                        <input  name="linkman" type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" value="<?=$info['linkman']?>" autocomplete="off" placeholder="请输入联系人" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" value="<?=$info['contact_info']?>"  name="contact_info" placeholder="请输入联系电话" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>邮箱:</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" value="<?=$info['email']?>" name="email" placeholder="请输入邮箱" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>手机号:</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" value="<?=$info['mobile']?>" name="mobile" placeholder="请输入手机号" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>地址(选填):</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" value="<?=$info['address']?>" name="address"  placeholder="请输入地址" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>网址(选填):</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" value="<?=$info['home_page']?>" name="home_page" placeholder="请输入网址" >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <textarea type="textarea" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" name="description" placeholder="请输入备注" ><?=$info['common']?></textarea>
                    </div>
                </div>
            </form>
        </div>
...
<script src="/static/js/public/iCheck/icheck.min.js"></script>script>
...
//        console.log(s);
        var s = result.size;
        // var s = result.size;
        // if (s > 50) return void alert("文件超出限制，请重新上传"); 2M 2097152
        if (s > 1024*1024*2){
            $('.img-des-zc').hide();
            $('.img-ts').show();
            return false;
...
//                console.log(l);
            ...
            s.onload = function() {
                var o = s.width + "px",
                    n = s.height + "px";
                // if (o > t && n > a) return alert("文件超出限制，请重新上传"),
