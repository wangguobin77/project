...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <a href="../../rbac/web/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu" style="display:none;">
                        <!-- Menu toggle button -->
                        <a href="../../rbac/web/#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="../../rbac/web/#">See All Messages</a></li>
                        </ul>
                    </li>
                    <!-- /.messages-menu -->
                    ...
                    <li class="dropdown notifications-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="../../rbac/web/#">View all</a></li>
                        </ul>
                    </li>
                    <!-- 头部 小红旗任务通知提示按钮 -->
                    <li class="dropdown tasks-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="../../rbac/web/#">View all tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- User Account Menu -->
                   ...
                   <!--          <li class="user-footer" >
                                <div class="pull-left">
                                    <a href="../../rbac/web/#" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">
                                    <a href="../../rbac/web/#" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li> -->
                        </ul>
                    </li>
                    ...
                    <li style="display:none;">
                        <a href="../../rbac/web/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
