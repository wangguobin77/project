            ...
            <form id="admin-user-form">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc" value="<?=$model['title']?>" autocomplete="off" name="title" placeholder="请输入部门名称" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" value="<?=$model['c_address']?>" autocomplete="off" name="c_address" placeholder="请输入部门地址">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12  input-xx">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <textarea type="text" name="condition" class="des form-control my-colorpicker1 colorpicker-element beizhu" autocomplete="off" placeholder="请输入备注信息" ><?=$model['condition']?></textarea>
                    </div>
                </div>
        </div>
        <div class="row col-md-12">
