            ...
            <form id="admin-user-form">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input type="text" id="org-s" class="form-control my-colorpicker1 colorpicker-element bmmc" autocomplete="off" name="title" placeholder="请输入机构名称" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc lxdz" autocomplete="off" name="c_address" placeholder="请输入联系地址" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>联系人:</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc lxr" autocomplete="off" name="contact_name" placeholder="请输入联系人" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>联系方式:</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc lxfs" autocomplete="off" name="mobile" placeholder="请输入联系方式" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-3 title'>邮箱(选填):</label>
                        <input type="text" class="form-control my-colorpicker1 colorpicker-element bmmc lxyx" autocomplete="off" name="c_email" placeholder="请输入邮箱" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12  input-xx">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <textarea type="text" name="condition" class="des form-control my-colorpicker1 colorpicker-element beizhu" autocomplete="off" name="real_name" placeholder="请输入备注信息" ></textarea>
                    </div>
                </div>
...
<script>
    ...
    $('.submit-btn').click(function(){
        ...
        $.ajax({
            url:'<?=Url::toRoute('admin-branch/addorg')?>',
            type:'post',
            dataType:'json',
            data:data,
