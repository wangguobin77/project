            ...
            <form id="mymessage-form">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input name="key" type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" value="<?=$info['key']?>" autocomplete="off"  placeholder="请输入由(a-zA-Z0-9-_. )组成的4-32位字符">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-5 title'>Code:</label>
                        <input name="code" type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off" value="<?=$info['code']?>" placeholder="请输入0x开头0-9a-f组成的4位字符">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-5 title'>版本:</label>
                        <input name="version" type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off" value="<?=$info['version']?>" placeholder="请输入0x开头0-9a-f组成的4位字符">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        <label class='col-md-5 title'>模拟参数:</label>
                        <input name="analog_params" type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off" value="<?=$info['analog_params']?>" placeholder="请输入大于等于零的数字">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <input name="normal_params" type="text" class="form-control my-colorpicker1 colorpicker-element bmdz" autocomplete="off" value="<?=$info['normal_params']?>" placeholder="请输入大于等于零的数字">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx" >
                        ...
                        <select name="can_map"  class="form-control select2 select2-hidden-accessible " style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <option value="1" <?php if($info['can_map'] == 1) echo 'selected';?> >是</option>
                            <option value="0" <?php if($info['can_map'] == 0) echo 'selected';?> >否</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <select name="canmap_once"  class="form-control select2 select2-hidden-accessible " style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <option value="1" <?php if($info['canmap_once'] == 1) echo 'selected';?> >是</option>
                            <option value="0" <?php if($info['canmap_once'] == 0) echo 'selected';?> >否</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12 input-xx">
                        ...
                        <select name="op_style"  class="form-control select2 select2-hidden-accessible col-md-7" style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <option value="1" <?php if($info['op_style'] == 1) echo 'selected';?> >有</option>
                            <option value="0" <?php if($info['op_style'] == 0) echo 'selected';?> >无</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group col-md-12 ">
                        ...
                        <div class="form-group col-md-12 input-xx">
                            ...
                            <div class='radio-inline' style='flex-wrap:wrap'>
                                <div class="col-md-10">
                                    <input type="checkbox" name="category_id[]" <?php if(in_array('0', $info['category_id'])) echo 'checked';?> class="minimal Applicable" value="0" id="settop"  />
                            ...
                            <div class='radio-inline' style='flex-wrap:wrap'>
                                <?php foreach($category as $val):?>
                                    <div class="col-md-3 no-break ">
                                        <input type="checkbox" name="category_id[]" <?php if(in_array($val['id'], $info['category_id'])) echo 'checked';?> class="minimal" value="<?=$val['id']?>" id="settop"  />
...
<script type="text/javascript">
    ...
    //初始化是否选中
    if($('input[type="checkbox"].Applicable').is(':checked')){
        $('.check-box-all').hide()
        // checkboxes.iCheck('uncheck');
    }


    $('input[type="checkbox"].Applicable').on('ifChecked', function(event){
    });
