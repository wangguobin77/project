                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="../../ota/web/#">See All Messages</a></li>
                        </ul>
                    </li>
                    <!-- /.messages-menu -->
                    ...
                    <li class="dropdown notifications-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="../../ota/web/#">View all</a></li>
                        </ul>
                    </li>
                    <!-- 头部 小红旗任务通知提示按钮 -->
                    <li class="dropdown tasks-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="../../ota/web/#">View all tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- User Account Menu -->
                    <li class="dropdown user user-menu">
                        ...
                        <a href="../../ota/web/#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src='/static/images/logomini.png' class="user-image hidden-lg" alt="User Image">
                   ...
                   <!--          <li class="user-footer" >
                                <div class="pull-left">
                                    <a href="../../ota/web/#" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">
                                    <a href="../../ota/web/#" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li> -->
                        </ul>
                    </li>
                    ...
                    <li style="display:none;">
                        <a href="../../ota/web/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
