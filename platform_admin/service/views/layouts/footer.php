...
<!--tishi-->
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display:none;">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li class="active"><a href="../../manufacture/web/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
            <li><a href="../../manufacture/web/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="control-sidebar-home-tab">
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="../../manufacture/web/javascript:;">
