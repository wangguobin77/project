...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="javascript:;" class="logo">
            ...
            <span class="logo-mini"><img src="../../keymap/web/images/logomini.png"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img src="../../keymap/web/images/logo_head.png"></span>
        </a>

        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top" role="navigation">
            <!-- Sidebar toggle button-->
            <a href="../../keymap/web/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu" style="display:none;">
                        <!-- Menu toggle button -->
                        <a href="../../keymap/web/#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="../../keymap/web/#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="../../keymap/web/images/logomini.png" class="img-circle" alt="User Image">
                                            </div>
                            ...
                            <li class="footer"><a href="../../keymap/web/#">See All Messages</a></li>
                        </ul>
                    </li>
                    <!-- /.messages-menu -->
                    ...
                    <li class="dropdown notifications-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="../../keymap/web/#">View all</a></li>
                        </ul>
                    </li>
                    <!-- 头部 小红旗任务通知提示按钮 -->
                    <li class="dropdown tasks-menu" style="display:none;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="../../keymap/web/#">View all tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- User Account Menu -->
                   ...
                   <!--          <li class="user-footer" >
                                <div class="pull-left">
                                    <a href="../../keymap/web/#" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">
                                    <a href="../../keymap/web/#" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li> -->
                        </ul>
                    </li>
                    ...
                    <li style="display:none;">
                        <a href="../../keymap/web/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
